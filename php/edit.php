...
<a href="../php/sistema.php">Voltar</a>
    ...
    <div class="box">
        <form action="form.php" method="post">
            <fieldset>
                <legend><b>Editar de clientes</b></legend>
                <br>
                <div class="inputBox">
                ...
                <p>Sexo:</p>
                    <input type="radio" name="genero" id="feminino" value="feminino" value="<?php echo $sexo == 'feminino' ? 'checked': '' ?>" required >
                    <label for="feminino">Feminino</label>
                    <br>
                    <input type="radio" name="genero" id="masculino" value="masculino" value="<?php echo $sexo == 'masculino' ? 'checked': '' ?>" required >
                    <label for="masculino">Masculino</label>
                    <br>
                    <input type="radio" name="genero" id="outro" value="outro" value="<?php echo $sexo == 'outro' ? 'checked': '' ?>" required >
