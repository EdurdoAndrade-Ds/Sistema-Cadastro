<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $result = mysqli_query($conexao, "INSERT INTO users(firstName,email,passwords,telefone,sexo,data_nasc,cidade,estado,endereco)
        VALUES ('$name','$email','$password','$telefone','$genero','$data_nasc','$cidade','$estado','$endereco')");
    } else {
        // echo 'nao enviado';
    }
